...
(atom-one-light-with-color-variables
 (custom-theme-set-faces
  ...
  `(font-lock-comment-face ((t (:italic t :foreground ,atom-one-light-mono-3))))
  `(font-lock-comment-delimiter-face ((default (:inherit (font-lock-comment-face)))))
  `(font-lock-doc-face ((t (:inherit (font-lock-string-face)))))
  `(font-lock-function-name-face ((t (:italic t :foreground ,atom-one-light-blue))))
  ...
  ;; mode-line
  `(mode-line ((t (:background ,atom-one-light-modeline :foreground ,atom-one-light-gray))))
